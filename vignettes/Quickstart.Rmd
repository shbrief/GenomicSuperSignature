...
your dataset. Besed on the heatmap table above, 1st-3rd RAVs (2538, 1139, and 884) 
...
PCAmodel and the index of the RAV you are interested in.
...
```{r message=FALSE, warning=FALSE}
if (!file.exists("PCAmodel_PLIERpriors.rds")) {getModel("PLIERpriors")} 
...
```{r}
subsetEnrichedPathways(PCAmodel, ind = PCNum, n = 3, both = TRUE)
subsetEnrichedPathways(PCAmodel, ind = 695, n = 3, both = TRUE)
subsetEnrichedPathways(PCAmodel, ind = 1994, n = 3, both = TRUE)
```

```{r}
annotateRAV(PCAmodel, ind = PCNum, n = 3, abs = FALSE)
annotateRAV(PCAmodel, ind = 695, n = 3, abs = FALSE)
annotateRAV(PCAmodel, ind = 1994, n = 3, abs = FALSE)
```
