...
res1 <- msigdb_gsea(validated_ind[1], RAVmodel, category = "C2")
dim(res1)
...
```{r echo=FALSE, eval=FALSE}
res2 <- msigdb_gsea(validated_ind[2], RAVmodel, category = "C2")
dim(res2)
...
```{r echo=FALSE, eval=FALSE}
res3 <- msigdb_gsea(validated_ind[3], RAVmodel, category = "C2")
dim(res3)
...
```{r echo=FALSE, eval=FALSE}
res4 <- msigdb_gsea(validated_ind[4], RAVmodel, category = "C2")
dim(res4)
