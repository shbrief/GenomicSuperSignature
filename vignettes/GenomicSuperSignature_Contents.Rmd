...
# Accessors
## RAVs
Averaged loadings (= RAVs) is the main part of GenomicSignatures, 
serving as an index connecting new datasets and the existing database. You can access 
it through `GenomicSuperSignature::model` (equivalent of `SummarizedExperiment::assay`). 
Rows are genes and columns are avgLoading vectors.

Here, PCAmodel consists of 13,934 genes and 4,764 RAVs.
